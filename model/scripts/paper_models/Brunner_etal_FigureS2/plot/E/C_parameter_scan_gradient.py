...
fig_path = "/home/brunner/Documents/Current work/2023_11_03/"  + "FigS2E_grad.pdf"
...
for s, sn in enumerate(scan_names):
    ...
    # print(name_df.scan_value.unique())
    # print(name_df["IL-2_kd"].unique())
