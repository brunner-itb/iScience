...
fig_path = "/home/brunner/Documents/Current work/2024_10_25/"  + "FigS2D_surf_c.pdf"
# fig_path = "/home/brunner/Documents/Current work/2024_10_25/"  + "FigS2D_act.pdf"
# fig_path = "/home/brunner/Documents/Current work/2023_07_14/"  + "Fig1C_CV.pdf"
...
labels = [r"R: receptors", r"$\sigma$: receptor heterog.", r" q: secretion rate", r"f$_{\rm sec}$: secreting cells",
          r"K$_{\rm D}$: saturation const.", r"D: diffusion const.", r"d$_{\rm c}$: cell-cell distance", r"$\eta$: cytokine decay"]
...
# cell_df = cell_df.loc[(cell_df["type_name"] == "Th") & (cell_df["numeric_linear"] == linear_uptake)]
...
for x in range(len(scan_names)):
    x_list.append(np.arange(x*1.35*N, x*1.35*N+N))
...
# rc_ticks['figure.figsize'] = [5, 3.6728999999999994]
...
# plt.legend(handles = [white_patch, grey_patch, black_patch], labels = ["fold change", "0.1", "10"], bbox_to_anchor=(1, 0.5))
