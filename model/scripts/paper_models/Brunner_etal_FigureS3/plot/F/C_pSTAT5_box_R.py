...
g1 = sns.barplot(data=scaled_df, y="activation", x="scan_variable", hue="fold_change", palette=["gainsboro", "grey", "black"],
                errwidth=1, linewidth=0.5, edgecolor="black", dodge=True, width=0.7)
ax.set(ylabel=r"pSTAT$^+$ (%)", xlabel="", ylim=(0,10))
plt.xticks([0.], [r"R hetero."], rotation=-0, ha="left")
...
ax.set(ylabel=r"pSTAT$^+$ (%)", xlabel="", title=r"$\sigma$: receptor heterog.", ylim=(-1/6,6))
