...
import model.main.GlobalResult
import model.main.MyError as MyError
import model.main.StateManager as st
from model.main.GlobalResult import GlobalResult
from model.main.ParameterSet import ParameterSet
from model.main.PostProcessUtil import get_mesh_volume, cast_mixed_columns_to_string
from model.main.PostProcessUtil import get_rectangle_plane_mesh, get_concentration_conversion, \
    get_gradient_conversion
from model.main.SimComponent import SimComponent
from model.main.myDictSorting import groupByKey
from model.main.my_debug import message, warning, setup_loggers
...
class FenicsScalarFieldComputation(PostProcessComputation):
    compatible_result_type = [model.main.GlobalResult.ScalarFieldResult]
...
class ParaviewRender(FenicsScalarFieldComputation):
    ...
    def make_paraview_images(self, visual_conv=1):
        ...
        from model.main import __path__ as main_path
...
class mean_c(ScalarComputation):
    compatible_result_type = [model.main.GlobalResult.ScalarResult]
    name = "Concentration"
